...
public class MenuPermissionService : BaseMgr, IMenuPermissionService
{
    ...
    public async Task<bool> DeleteAsync(Guid id)
    {
        ...
        await _unitOfWork.ExecuteInTransactionAsync(async () =>
        {
            ...
            await _unitOfWork.GetDbContext().Set<SysRolePermission>().Where(x => x.PermissionId.Equals(id))
                .DeleteAsync();
    ...
    public async Task<List<SysMenuPermission>> GetTreeAsync(Guid? rootId = null, int? maxDepth = null,
        CancellationToken cancellationToken = default)
    {
